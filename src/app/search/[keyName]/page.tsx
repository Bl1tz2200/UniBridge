...
var university: universityPageInfo = { // Getting them from the DB
  ...
  dateEnd: "01.08",
  scholarship: "full",
  accomadation: "dormitory on campus",
  subjects: ["maths", "chemistry"],
  qualifications: ["phd", "master"],
  additionalPrograms: ["language coarse", "summer camps", "summer intensives"],
  ...
  return (
    <>
      ...
      <section className='pt-20 mt-20 border-t-5 border-(--accent) grid grid-cols-1 justify-center justify-items-center w-11/12 justify-self-center px-5'>
        <span className='text-center text-4xl mb-10 text-(--accent) font-bold'>Details:</span>
        <ul className="grid grid-cols-1 md:grid-cols-2 justify-center items-center content-center justify-items-center pb-2.5 gap-5 md:gap-10">
          ...
          <li className="flex gap-1.5 items-center content-center justify-center justify-items-center text-2xl sm:text-3xl">
            <span className="text-center font-semibold">Scholarship:</span>
            <span className="text-center">{university.scholarship}</span>
          </li>
          <li className="flex gap-1.5 items-center content-center justify-center justify-items-center text-2xl sm:text-3xl">
            <span className="text-center font-semibold">Accomadation provided:</span>
            <span className="text-center">{university.accomadation}</span>
          </li>
        </ul>
      </section>
      <section className='flex items-start content-center justify-center justify-items-center flex-wrap gap-10 sm:gap-7.5 mt-25 px-10'>
        <div className='grid grid-cols-1 items-center content-center justify-center px-1 sm:px-5 sm:w-125'>
        ...
        <div className='grid grid-cols-1 items-center content-center justify-center px-1 sm:px-5 sm:w-125'>
          <span className='text-center text-4xl w-full font-semibold'>Top subjects:</span>
          <ul className='mt-5'>
            {
        ...
        <div className='grid grid-cols-1 items-center content-center justify-center px-1 sm:px-5 sm:w-125'>
          <span className='text-center text-4xl font-semibold'>Additional programs:</span>
          <ul className='mt-5'>
            {
              university.additionalPrograms.map((additionalProgram: string) => {
                return (
                  <li className='text-2xl sm:text-3xl text-center mt-2.5' key={additionalProgram}>
                    {additionalProgram}
                  </li>
                )
              })
      ...
      <section className='mt-25 grid grid-cols-1 justify-center justify-items-center justify-self-center px-5 w-full'>
        ...
        <ul className='flex items-start justify-center px-5 flex-wrap gap-10'>
          <li className='grid grid-cols-1 items-center content-center justify-center px-1 sm:px-5 sm:w-125'>
            ...
            <ul className='mt-5'>
              {
                university.elegibility.general.map((elegibility: string) => {
                  return (
                    <li className='text-2xl sm:text-3xl text-center mt-2.5' key={elegibility}>
                      {elegibility}
                    </li>
                  )
                })
